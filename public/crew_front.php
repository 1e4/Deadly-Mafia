...
if (strip_tags($_POST['points_button']) && strip_tags($_POST['points_amount'])){
$points_amount=intval(strip_tags($_POST['points_amount']));

		if ($points_amount == 0 || !$points_amount || ereg('[^0-9]',$points_amount)){
	print "You cant deposit that amount of points.";
	
}elseif ($points_amount != 0 && $points_amount && !ereg('[^0-9]',$points_amount)){



	if ($points_amount > $fetch->points){
	echo "You do not have that many points";
	}elseif ($points_amount <= $fetch->points){
	$user_loose = $fetch->points - $points_amount;
	$new_bank = $crew->points + $points_amount;

	mysql_query("UPDATE users SET points = '$user_loose' WHERE username='$username'");
	mysql_query("UPDATE crews SET points = '$new_bank' WHERE name='$crew->name'");

echo "points successfully donated!";
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
    <tr> 
      <td width="53%"><table width="100%" border="1" cellspacing="0" cellpadding="0" class=thinline rules=none >
          ...
          <tr> 
            <td><table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#666666">
                <tr> 
                  <td colspan="2"> <div align="center" class="style1">Donate:</div></td>
                </tr>
                <tr> 
                  <td width="50%"><span class="style2">Current balance:</span></td>
                  <td width="50%"><span class="style2"><?php echo "£".makecomma($crew->bank).""; ?></span></td>
                </tr>
                <tr> 
      ...
      <td width="47%"><table width="100%" border="1" cellspacing="0" cellpadding="0" class=thinline rules=none>
          ...
          <tr> 
            <td><table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#666666">
                <tr> 
                  <td colspan="2"> <div align="center" class="style2"><strong>Donate:</strong></div></td>
                </tr>
                <tr> 
                  <td width="50%"><span class="style2">Current bullets in bank:</span></td>
                  <td width="50%"><span class="style2"><?php echo "£".makecomma($crew->bullets).""; ?></span></td>
                </tr>
                <tr> 
                  <td><span class="style2">Amount</span></td>
    ...
    <tr>
      <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#666666" rules=none class=thinline >
        <tr>
          <td class="header"><center>
        Crew Points Account 
          </center></td>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              ...
              <tr>
                <td width="50%"><span class="style2">Current Points balance:</span></td>
                <td width="50%"><span class="style2"><?php echo "".makecomma($crew->points).""; ?></span></td>
              </tr>
              <tr>
                <td><span class="style2">Amount</span></td>
                <td width="50%"><input name="points_amount" type="text" id="points_amount"></td>
              </tr>
              <tr>
                <td colspan="2"><div align="right">
                    <input name="points_button" type="submit" id="points_button" value="Donate Points">
                </div></td>
              </tr>
          </table></td>
        </tr>
