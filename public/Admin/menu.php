...
<link href="/MANAGEMENT_CENTER/css.css" rel="stylesheet" type="text/css" />
<style type="text/css">
<!--
a:link {
	color: #CCCCCC;
...
<p class="menutext"><a href="kill_user.php" target="mainFrame">Kill A User</a></p>
 ...
 <p class="menutext"><a href="java.php" target="mainFrame">Java Message </a></p>
 <p class="menutext">
   <? } ?>
</p>
 ...
 <p class="menutext"><a href="http://www.e-mafia.co.uk/oeticket.php" target="mainFrame">Ticket CP </a></p>
 <p class="title">Scans</p>
 <p class="menutext"><a href="dupe_check.php" target="mainFrame">Scan For Dupes</a></p>
