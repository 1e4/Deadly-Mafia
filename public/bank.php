...
if((strip_tags($_POST['dep_amount'])) && (strip_tags($_POST['Dep_button']))){
	...
	$dep_amount=intval($_POST['dep_amount']);
				...
				$send_amount=intval($_POST['send_amount']);
                    ...
                    elseif ($send_amount <= $fetch->money)
                    {
                        ...
                        elseif (strtolower($to_person) != strtolower($username)){
							...
							mysql_query("INSERT INTO `transfers` ( `id` , `to` , `from` , `amount` , `date` ) VALUES ('', '$to_person', '$username', '$send_amount', '$gmt_time');") or die (mysql_error());
...
<table width="69%" border="1" align="center" cellpadding="0" cellspacing="0" class=thinline rules=none>
  <tr> 
    <td bckground="includes/grad.jpg" background="includes/grad.jpg"><center>Bank</center></td>
  </tr>
  ...
  <tr> 
    <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
        ...
        <tr> 
          ...
          The intrest taken off your cash sent is 10%               <a href="swiss1.php" target="main"> Enter your Swiss Bank!</a><br /></td>
        </tr>
		     <tr> 
        ...
        <tr> 
          ...
          <td width="20%" height="2"><input name="Dep_button" type="submit" id="Dep_button" value="Deposit" <?php if ($fetch->bank > "0"){ echo "Disabled"; } ?>></td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td height="-3" colspan="2"><input name="send_amount" type="text" id="send_amount" maxlength="12"></td>
        </tr>
        <tr> 
...
<table width="69%" border="1" align="center" cellpadding="0" cellspacing="0" class=thinline rules=none>
  <tr> 
    <td background="includes/grad.jpg" colspan=4><center>
...
<p>&nbsp;</p>
              ...
              <a href="swiss1.php" target="main">&gt; Swiss Bank!</a><br />
<?php 
