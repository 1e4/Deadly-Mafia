...
?><link href="includes/test.css" rel="stylesheet" type="text/css"> <? $input="Slots";
...
<table width="56%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="black" rules=none class=thinline>
  ...
  <tr> 
    <td width="32%"> 
      <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="black" bgcolor="#666666">
        <tr>
          <td>
    ...
    <td width="38%"> 
      <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="black" bgcolor="#666666">
        <tr> 
          <td bgcolor="#666666">
            <?php if ($ticked == 1){  echo "<img src=$images[$thing1]>"; } ?>          </td>
        </tr>
      </table></td>
    <td width="30%"> 
      <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="black" bgcolor="#666666">
  ...
  <tr> 
    <td height="26" colspan="3" bgcolor="#666666">
<div align="center">
...
<center>
<?php if ($slots->owner == "0"){ ?>
<table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td background="includes/grad.jpg"><div align="center">Owner </div></td>
  </tr>
  <tr>
    <td bgcolor="#999999"><div align="center"><?  echo "This slots table is not owned";  ?></div></td>
    </tr>
</table>
...
<table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    <td bgcolor="#999999"><div align="center"><? echo "This slots table is owned by <a href='profile.php?viewuser=$slots->owner'><b>$slots->owner</b></a>"; } ?></div></td>
    </tr>
</table><p>
<table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
  ...
  <tr>
    <td bgcolor="#999999"><div align="center"><?php echo "<br>The max bet is set at £".makecomma($slots->max).""; ?></div></td>
    </tr>
</table>
