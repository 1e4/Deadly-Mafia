...
if(($col) && ($bet)){
    ...
    if($bet > $fetch->money || $bet > $race->max){
        echo '
        ...
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#FFCC00"><div align="center">You dont have that much money to bet or you have exceded the max bet!</div></td>
            </tr>
        </table>
        </div>';
    }else{
        ...
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#FFCC00"><div align="center">You must be an amount greater than zero!</div></td>
            </tr>
        </table>
        </div>';
        ...
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#FFCC00"><div align="center">You can only bet whole amounts!</div></td>
            </tr>
        </table>
        </div>';
    } else {
        mysql_query("UPDATE users SET money-'$bet' WHERE username='$username'");
        mysql_query("UPDATE users SET money+'$bet' WHERE username='$race->owner'");
        ...
        if($col == $win_cul){
            mysql_query("UPDATE users SET money+'$win' WHERE username='$username'");
            mysql_query("UPDATE users SET money-'$win' WHERE username='$race->owner");
            ...
            echo '
                ...
                <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                  ...
                  <tr>
                    <td bgcolor="#00FF00"><div align="center">You won, with '.$col.'. You won £'.$win.'</div></td>
                    </tr>
                </table>
                </div>';
        }else{
            echo '
                ...
                <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                  ...
                  <tr>
                    <td bgcolor="#FF0000"><div align="center">You lost. Try again next time!</div></td>
                    </tr>
                </table>
                </div>';
        }
    ...
    echo '
        ...
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#FFCC00"><div align="center">Please enter an amount to bet!</div></td>
            </tr>
        </table>
        </div>';
}elseif($bet){
    echo '
        ...
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#FFCC00"><div align="center">Please select a colour to bet on!</div></td>
            </tr>
        </table>
        </div>';
}
...
if( $race->owner != "0") {
    if($username <> $race->owner){
        ...
        echo 'This race track has no owner click <a href="?action=takeover">here</a> to take it over';
    }
    ...
    if($username == $race->owner){
        echo '
            ...
            <table width="300" border="1" align="center" bordercolor="#000000" class="background">
              ...
              <tr>
                <th bgcolor="#999999" scope="row">Profit: £'.makecomma($race->profit).'
              </th>
              </tr>
              <tr>
    ...
    echo '
        ...
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#999999"><div align="center">The max bet is currently set at &pound;'.$race->max.'</div></td>
            </tr>
        </table>
        <p>&nbsp;</p>
        <table width="300" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <tr>
            <td bgcolor="#999999"><div align="center">The casino is owned by '.$race->owner.'</div></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        </div>
