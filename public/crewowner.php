  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
      ...
      <td width="53%"><table width="100%" border="1" cellspacing="0" cellpadding="0" class=thinline rules=none >
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td colspan="2" bgcolor="#666666"> <div align="center" class="style2"><strong>Donate:</strong></div></td>
                </tr>
                <tr> 
                  <td width="50%" bgcolor="#666666"><span class="style2">Current balance:</span></td>
                  <td width="50%" bgcolor="#666666"><span class="style2"><?php echo "£".makecomma($crew->bank).""; ?></span></td>
                </tr>
                <tr> 
                  <td bgcolor="#666666"><span class="style2">Amount</span></td>
                  <td width="50%" bgcolor="#666666"><input name="donate_amount" type="text" id="donate_amount"></td>
                </tr>
                <tr> 
                  <td colspan="2" bgcolor="#666666"><div align="right"> 
      ...
      <td width="47%"><table width="100%" border="1" cellspacing="0" cellpadding="0" class=thinline rules=none>
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="50%" bgcolor="#666666"><span class="style2">Current bullets in bank:</span></td>
                  <td width="50%" bgcolor="#666666"><span class="style2"><?php echo "£".makecomma($crew->bullets).""; ?></span></td>
                </tr>
                <tr> 
                  <td bgcolor="#666666"><span class="style2">Amount</span></td>
                  <td width="50%" bgcolor="#666666"><input name="bullet_amount" type="text" id="donate_amount3"></td>
                </tr>
                <tr> 
                  <td colspan="2" bgcolor="#666666"><div align="right" class="style2"> 
                      <input name="withdraw_button" type="submit" id="donate_button4" value="Withdraw Bullets">
    ...
    <tr> 
      <td><table width="100%" border="1" cellspacing="0" cellpadding="0" class=thinline rules=none >
        ...
        <tr>
          <td><table width="101%" border="0" cellpadding="0" cellspacing="3" bgcolor="#666666">
              <tr>
