...
?> 
        ...
        <tr> 
          ...
          <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onmouseout="this.style.background='';"> 
            <a href="fotoalbum.php" target="middle"><span class="style3">&raquo;</span>Photo Album</a></td>
        </tr>
        <tr> 
          <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onmouseout="this.style.background='';"> 
  ...
  <tr> 
    <td><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onMouseOut="this.style.background='';"><a href="bf.php" target="middle" class="style3">&raquo;Bullet Factory</a> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onMouseOut="this.style.background='';"><p><a href="bank.php" target="middle" class="style3">&raquo;Bank</a></p>
          <p><a href="safe.php" target="middle" class="style3">&raquo;Safehouse</a></p></td>
      </tr>
      <tr>
  ...
  <tr> 
    <td><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000">
        ...
        <tr> 
          <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onmouseout="this.style.background='';"> 
            <a href="depot.php" target="middle"><span class="style3">&raquo;Tune Shop</span></a></td>
        </tr>
        <tr> 
          <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onmouseout="this.style.background='';"> 
...
<tr> 
        ...
        <tr> 
          <td bordercolor="#999999" onMouseOver="this.style.background='white';this.style.cursor='hand';" onmouseout="this.style.background='';"> 
            <a href="stats.php" target="middle"><span class="style3">&raquo;Statistics</span></a></td>
        </tr>
        <tr>
