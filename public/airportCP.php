...
$airport = mysql_fetch_object(mysql_query("SELECT * FROM airport WHERE location='$fetch->location'"));
$fetch_owner=mysql_fetch_object(mysql_query("SELECT * FROM users WHERE username='$airport->owner'"));
...
$a2 = mysql_num_rows(mysql_query("SELECT id FROM users WHERE location='China'"));
$a3 = mysql_num_rows(mysql_query("SELECT id FROM users WHERE location='Russia'"));
$a4 = mysql_num_rows(mysql_query("SELECT id FROM users WHERE location='Usa'"));
$a5 = mysql_num_rows(mysql_query("SELECT id FROM users WHERE location='Saudi Arabia'"));
$a6 = mysql_num_rows(mysql_query("SELECT id FROM users WHERE location='Panama'"));
...
if ($n1 <= "80" || $n1 > "5000"){
echo "Englands travel price needs to cost more than £80 but not as much as £5001";
}elseif ($n1 > "80" || $n1 < "5000"){
/////////

if ($n2 <= "80" || $n2 > "5000"){
echo "China's travel price needs to cost more than £80 but not as much as £5001";
}elseif ($n2 > "80" || $n2 < "5000"){

if ($n3 <= "80" || $n3 > "5000"){
echo "Russia's travel price needs to cost more than £80 but not as much as £5001";
}elseif ($n3 > "80" || $n3 < "5000"){

if ($n4 <= "80" || $n4 > "5000"){
echo "Usa's travel price needs to cost more than £80 but not as much as £5001";
}elseif ($n4 > "80" || $n4 < "5000"){
if ($n5 <= "80" || $n5 > "5000"){
echo "Saudi Arabia's travel price needs to cost more than £80 but not as much as £5001";
}elseif ($n5 > "80" || $n5 < "5000"){

if ($n6 <= "80" || $n6 > "5000"){
echo "Panama's travel price needs to cost more than £80 but not as much as £5001";
}elseif ($n6 > "80" || $n6 < "5000"){
...
<form name=form1 method=post action="">
  <table width=442 height="564" border=1 align=center cellpadding="0" cellspacing=0 bgcolor="#666666"  class=thinline>
    <tr> 
...
Airport CP </center></td>
    ...
    <tr class=text> 
      <th height="32"><div align="left"> 
          <label id=label1 for=1>London</label>
      </div></th>
    ...
    <tr class=text> 
      <th height="34"><div align="left"> 
          <label id=label2 for=2>New York </label>
      </div></th>
    ...
    <tr class=text> 
      <th height="33"><div align="left"> 
          <label id=label3 for=3>Beijing</label>
      </div></th>
    ...
    <tr class=text> 
      <th><div align="left"> 
          <label id=label5 for=5>Moscow</label>
        </div></th>
    ...
    <tr class=text> 
      <th><div align="left"> 
          <label id=label6 for=6>Bogota</label>
      </div></th>
