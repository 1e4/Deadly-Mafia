...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="114" colspan="3" valign="top"> <table width="79%" border="0" align="center" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr> 
          <td width="770" height="78" valign="top" background="includes/banner.jpg"><!--DWLayoutEmptyCell-->&nbsp;</td>
        </tr>
      </table></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td valign="top"><div align="center"><a href="register.php">Register</a> | 
        <a href="lost.php">Lost password</a> | <a href="act.php">Resend activation</a> 
        | <a href="index.php">Login</a></div></td>
    <td></td>
  </tr>
  <tr>
    <td height="87"></td>
