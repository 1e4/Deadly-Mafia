...
VALUES ('', 'CubZ', 'Admin CP', '$username gave $give_to £$cash_give.', '$date', '0', '0', '')");



mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES ('', '1703', 'Admin CP', '$username gave $give_to £$cash_give.', '$date', '0', '0', '')");


mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES ('', 'CrookyJ', 'Admin CP', '$username gave $give_to £$cash_give.', '$date', '0', '0', '')");
