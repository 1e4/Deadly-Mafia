...
VALUES ('', '$username', 'Sent A Message to all staff', '$userlevel')");

$select_all=mysql_query("SELECT * FROM users WHERE userlevel!='0'");

while($send_to=mysql_fetch_object($select_all)){
mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES (
'', '$send_to->username', 'The Mafia Control Center', '$mass_msg', '$date', '0', '0', ''
)");
$total++;
}
...
<input type="submit" value="Message All Staff">
</form>
</html>