...
<DIV align=center><span class="style1"><b>Kill Logs </b></span></DIV>
</TD></TR>
  <TR>
    <TD>
      <P><div align=center>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="154">Killer:</td>
    <td width="389">Date:</td>
  </tr>
<?php
...
?>
  <tr>
    ...
    <td width="154"><? print"$object->username";?></td>
    <td width="389"><? print"$object->date";?></td>
</tr>
<?php
	}
$num ++
