...
$made = $success[8];
	...
	?>
<table width=100% border=1 cellspacing=0 cellpadding=2  class=thinline bordercolor=black><tr><td  background=file:///C|/Documents%20and%20Settings/J/Desktop/dtop/public_html/includes/grad.jpg align=left><center class=TableHeading>Topic Made By : <? echo "<a href='profile.php?viewuser=$username1' target=middle>$username1</a>"; ?> On :<?php echo "$made"; ?></center></td></tr>
...
$viewtopic = $_GET['viewtopic'];
	if ($index != 0) {
		print "<a href=\"righta.php?forum=$forum&viewtopic=$viewtopic&forum_look=" . ($index - $count) . "\">Previous</a> ";
	}
	if ($num == $count) {
		print " <a href=\"righta.php?forum=$forum&viewtopic=$viewtopic&forum_look=" . ($index + $count) . "\">Next</a>";
	}
...
window.location='righta.php?forum=$forum&viewtopic=$g';
</script>";
...
window.location='righta.php?forum=$forum&viewtopic=$viewtopic';
</script>";
