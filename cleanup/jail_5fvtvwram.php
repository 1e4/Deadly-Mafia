...
<table mmdw=0 width="39%" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor=black class=thinline>
  <tr>
    <td mmdw=1 background=includes/grad.jpg><div mmdw=2 align="center">Key</div></td>
  </tr>
  <tr>
    <td><div mmdw=3 align="center">*Unbreakable</div></td>
  </tr>
</table>
<p>
<!--MMDW 2 --><?php include_once"includes/footer.php"; ?><!--MMDW 3 -->
