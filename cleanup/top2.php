...
<table width="100%" border="1" cellpadding="2" cellspacing="0" class=thinline bordercolor="black">
      ...
      <?
	   $e = mysql_query("SELECT * FROM users WHERE userlevel='0' ORDER BY `rankpoints` DESC LIMIT 10");
	   while($f = mysql_fetch_array($e)){
		   echo "<tr><td bgcolor=666666><a href='crewprofile.php?viewcrew={$f['crew']}'>{$f['crew']}</a></td><td bgcolor=666666>{$f['rankpoints']}</td></tr>\n";	   
	   }
	   ?>   
      </table>
<br /><br /><br />
