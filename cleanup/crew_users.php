...
//////////////////////////////////
//////////////////////////////////////
if (strip_tags($_POST['tres1_button']) && strip_tags($_POST['tres1_username'])){
$tres1_username= strip_tags($_POST['tres1_username']);
$check_query=mysql_query("SELECT * FROM users WHERE username='$tres1_username'");
$check_excist = mysql_num_rows($check_query);
$fetch_check = mysql_fetch_object($check_query);
...
mysql_query("UPDATE crews SET tres1='$tres1_username' WHERE name='$crew->name'");
$message = "You have been elected as a Treasurer for your crew!";

mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES (
'', '$tres1_username', '$tres1_username', '$message', '$date', '0', '0', ''
)");
echo "Treasurer 1  assigned";
}}}

//////////////////////////////////
if (strip_tags($_POST['tres2_button']) && strip_tags($_POST['tres2_username'])){
$tres2_username= strip_tags($_POST['tres2_username']);
$check_query=mysql_query("SELECT * FROM users WHERE username='$tres2_username'");
$check_excist = mysql_num_rows($check_query);
$fetch_check = mysql_fetch_object($check_query);
...
mysql_query("UPDATE crews SET tres2='$tres2_username' WHERE name='$crew->name'");
$message = "You have been elected as a Treasurer for your crew!";

mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES (
'', '$tres2_username', '$tres2_username', '$message', '$date', '0', '0', ''
)");
echo "Treasurer 2  assigned";
}}}
//////////////////////////////////
if (strip_tags($_POST['tres3_button']) && strip_tags($_POST['tres3_username'])){
$tres3_username= strip_tags($_POST['tres3_username']);
$check_query=mysql_query("SELECT * FROM users WHERE username='$tres3_username'");
$check_excist = mysql_num_rows($check_query);
$fetch_check = mysql_fetch_object($check_query);
...
mysql_query("UPDATE crews SET tres3='$tres3_username' WHERE name='$crew->name'");
$message = "You have been elected as a Treasurer for your crew!";

mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES (
'', '$tres3_username', '$tres3_username', '$message', '$date', '0', '0', ''
)");
echo "Treasurer 3  assigned";
}}}
//////////////////////////////////
if (strip_tags($_POST['rec1_button']) && strip_tags($_POST['rec1_username'])){
$rec1_username= strip_tags($_POST['rec1_username']);
$check_query=mysql_query("SELECT * FROM users WHERE username='$rec1_username'");
$check_excist = mysql_num_rows($check_query);
$fetch_check = mysql_fetch_object($check_query);
...
mysql_query("UPDATE crews SET rec1='$rec1_username' WHERE name='$crew->name'");
$message = "You have been elected as a Recruiter for your crew!";

mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES (
'', '$rec1_username', '$rec1_username', '$message', '$date', '0', '0', ''
)");
echo "Recruiter 1 assigned";
}}}
//////////////////////////////////

if (strip_tags($_POST['rec2_button']) && strip_tags($_POST['rec2_username'])){
$rec2_username= strip_tags($_POST['rec2_username']);
$check_query=mysql_query("SELECT * FROM users WHERE username='$rec2_username'");
$check_excist = mysql_num_rows($check_query);
$fetch_check = mysql_fetch_object($check_query);
...
mysql_query("UPDATE crews SET rec2='$rec2_username' WHERE name='$crew->name'");
$message = "You have been elected as a Recruiter for your crew!";

mysql_query("INSERT INTO `inbox` ( `id` , `to` , `from` , `message` , `date` , `read` , `saved` , `event_id` ) 
VALUES (
'', '$rec2_username', '$rec2_username', '$message', '$date', '0', '0', ''
)");
echo "Recruiter 2 assigned";
}}}
//////////////////////////////////
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                ...
                <td width="57%"><?php if ($crew->cm1 == "0"){ echo "None"; }else{ echo "$crew->cm1"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm1_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm1_button" type="submit" id="cm1_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm2== "0"){ echo "None"; }else{ echo "$crew->cm2"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm2_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm2_button" type="submit" id="cm2_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm3== "0"){ echo "None"; }else{ echo "$crew->cm3"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm3_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm3_button" type="submit" id="cm3_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm4== "0"){ echo "None"; }else{ echo "$crew->cm4"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm4_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm4_button" type="submit" id="cm4_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm5== "0"){ echo "None"; }else{ echo "$crew->cm5"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm5_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm5_button" type="submit" id="cm5_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm6== "0"){ echo "None"; }else{ echo "$crew->cm6"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm6_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm6_button" type="submit" id="cm6_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm7== "0"){ echo "None"; }else{ echo "$crew->cm7"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm7_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm7_button" type="submit" id="cm7_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->cm8== "0"){ echo "None"; }else{ echo "$crew->cm8"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="cm8_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="cm8_button" type="submit" id="cm8_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->tres1== "0"){ echo "None"; }else{ echo "$crew->tres1"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="tres1_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="tres1_button" type="submit" id="tres1_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->tres2== "0"){ echo "None"; }else{ echo "$crew->tres2"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="tres2_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="tres2_button" type="submit" id="tres2_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->tres3== "0"){ echo "None"; }else{ echo "$crew->tres3"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="tres3_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="tres3_button" type="submit" id="tres3_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->rec1== "0"){ echo "None"; }else{ echo "$crew->rec1"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="rec1_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="rec1_button" type="submit" id="rec1_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
      ...
      <td ><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>" >
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="43%">Current</td>
                <td width="57%"><?php if ($crew->rec2== "0"){ echo "None"; }else{ echo "$crew->rec2"; } ?></td>
              </tr>
              <tr>
                <td>Username</td>
                <td><input name="rec2_username" type="text" id="war_reason"></td>
              </tr>
              <tr>
                <td height="19" colspan="2"><div align="right">
                    <input name="rec2_button" type="submit" id="rec2_button" value="Assign">
                </div></td>
              </tr>
          </table></td>
        </tr>
