...
if($offer != ""){
	...
	if($offer < 0){ echo "You can't go below 0!"; }
	...
	elseif($username == $bjowner){ echo "You can't make an offer to yourself!"; }
...
if($_POST['adeal']){
	...
	if($yid != ""){ 
		...
		elseif($owner != $username){ echo "Thats not your blackjack!"; } else {
			...
			mysql_query("INSERT INTO `inbox` (`id`, `to`, `from`, `date`, `text`) VALUES ('', '$offerer', 'Country Ownership', NOW(), '$message');");
		...
		mysql_query("INSERT INTO `inbox` (`id`, `username`, `from`, `date`, `text`) VALUES ('', '$offerer', 'Country Ownership', NOW(), '$message');");
...
<form name=form3 method=post action=$self>
 ...
 <table width=55% border=1 cellspacing=0 cellpadding=0 bordercolor=black class=thinline>
    ...
    <tr>
      ...
      <td colspan=5 background=includes/grad.jpg><b><center> Blackjack </center></b></td>
...
<center>
  ...
  <tr>
  	...
  	<td colspan=30 background=includes/grad.jpg><b><center>Table</center></b></td>
...
<form name="form4" method="post" action="<?php $_SERVER['PHP_SELF'] ?>">&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="submit2" value="   Stand   " />
...
<form method='post' action='blackjack2.php'>


  <center><table cellspacing=0 cellpadding=0 align=center border=1 bordercolor=black class=thinline><tr><td background=includes/grad.jpg><b><center>Owned</center></b></td></tr><tr class=text align=center><td>This blackjack is owned by <a href=\"profile.php?viewuser=$owner\"><b>$owner</b></a></td></tr><tr class=text align=center><td>The max bet is currently <b>$bjmaxbet</b></td></tr><tr class=text><td>Make An Offer To Take This Blackjack Over: <input name=offer type=text class=submit size=10 maxlength=10><br></td></tr><tr class=text>
