...
if($target->protection == "Safehouse"){ $target_protection = 60; }
elseif($target->protection == "House"){ $target_protection = 20; }
elseif($target->protection == "Armoured Car"){ $target_protection = 10; }
elseif($target->protection == "Body Guard"){ $target_protection = 8; }
elseif($target->protection == "Doberman"){ $target_protection = 4; }


if($fetch->weapon == "Browning M2HB"){ $your_gun_power = "6"; $gunpower = $kill_bullets*.000100; }
elseif($fetch->weapon == "FN SCAR"){ $your_gun_power = "5"; $gunpower = $kill_bullets*.00080; }
elseif($fetch->weapon == "Heckler und Koch MP-5k"){ $your_gun_power = "4"; $gunpower = $kill_bullets*.00040; }
elseif($fetch->weapon == "Jackhammer automatic shotgun"){ $your_gun_power = "3"; $gunpower = $kill_bullets*.00020; }
...
VALUES (
'', '$dns->username', '$dns->username', 'You witnessed $username kill $target->username ', '$date', '0', '0', '0', '1', '$target->username'
)");
$i++;
}}
