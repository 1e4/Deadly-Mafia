...
elseif($target->protection == "Doberman"){ $target_protection = 5; }
...
elseif($fetch->weapon == "Sig Sauer P229"){ $your_gun_power = "15"; $gunpower = $kill_bullets*.01000 * 10; }
...
Your gunpower  $your_gun_power<br>
Your bullet power: $gunpower<br>
Your rankpower: $ran<br>
";
...
Columbia<br>
<input name="Manchester" type="checkbox" id="Manchester22" value="4">
Usa
