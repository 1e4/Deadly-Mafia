...
<title>...:::Web Design:::...</title><style type="text/css">
body {
...
<div align="center">
  ...
  <table width="881" height="453" border="1"><tr><td colspan="2"></div><tr><td colspan="2"></td>
        <tr>
            <td bgcolor="#FFFFFF" class="style4"><span class="style4 style20"><font face="verdana" size="1.5">
              <?php
...
?>
          ...
          <td width="596" rowspan="7" bgcolor="#FFFFFF"><p class="style4 style15">Welcome to the pics area, please email your pics and i will add em to the site, they can be of anything you've photographed but nothin really explicit make your own site for that </p>
            <table width="574" border="1">
              <tr class="style22">
                <td>Castle Park Playground </td>
                <td>Overstrand</td>
              </tr>
              <tr class="style22">
                <td>Hole in wall at overstrand</td>
                <td>Jack stuck in budgie the helicopter </td>
              </tr>
            </table>            <p class="style4 style15">&nbsp;</p></td>
        </tr>
      <tr>
      ...
      <tr>
        <td bgcolor="#FFFFFF" class="style4"><a href="http://www.empire2010.com/oldskool.php" class="style22">Oldskool stuff</a></td>
      </tr>
      <tr>
